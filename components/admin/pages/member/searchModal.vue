        ...
        <Row :class="rowHeight">
            <i-Col span="20">
                <Row>
                    ...
                    <i-Col span="6">
                        <FormItem class="search-form-item" label="帳號" prop="username">
                            <Input v-model.trim="searchFormValidate.username" maxlength="64" placeholder="請輸入關鍵字"></Input>
                        </FormItem>
                    </i-Col>                    
                    <i-Col span="6">
        ...
        searchHandleSubmit(name) {
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    // }      
                    if (this.searchFormValidate.username !== '') {
                        num += 1
                        str += ' and username like \'' + this.searchFormValidate.username + '\'  '
                    }                                                
