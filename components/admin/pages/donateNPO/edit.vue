    ...
    <Layout class="main">
        <div class="edit-form">
            ...
            <div class="edit-form-content">
                <div class="form-head">
                    <div class="form-head-title">5180企業資料更新</div>
                </div>
        ...
        editHandleSubmit(name) {
            this.$refs[name].validate((valid, error) => {
                if (valid) {
                    ...
                    let _this = this
                    let errorDesc = ''
                    this._API.patchDonationNpos.send(data).then((data) => {
                        ...
                        if (_this.npoIconFile) {
                            ...
                            this._API.putDonateNPOFile.requestCommon(this.$route.params.id, 'icon')
