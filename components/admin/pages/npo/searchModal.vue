        ...
        searchHandleSubmit(name) {
            this.$refs[name].validate((valid) => {
                if (valid) {
                    ...
                    let [num, data, str] = [0, '', ' isVerified eq true ']
                     ...
                     if (this.searchFormValidate.type !== 'all') {
                        ...
                        switch(this.searchFormValidate.type) {
                            case '1': //志工NPO
                                ...
                                str += ' and isVerified eq true and isEnterprise eq false  '
                                break;
                            // case '2': //物資NPO
                            ...
                            case '3': //企業志工
                                ...
                                str += ' and isVerified eq true and isEnterprise eq true  '
                                break;                                                                
                        }
                    ...
                    if (this.searchFormValidate.isInventory) {
                        num += 1
                        str += ' and isInventory eq true '
                    }
                    if (num === 0) {
                        data = ''
                    } else {
