...
<div class="main">
    ...
    <div class="edit-form">
        ...
        <div class="edit-form-content">
            <div class="form-head">
                <div class="form-head-title">NPO邀請</div>
            </div>
            ...
            <Form id="editFormValidate" ref="editFormValidate" :model="editFormValidate" :rules="editRuleValidate" label-position="top">
                ...
                <Row>
                    <i-Col span="12">
                        <FormItem class="edit-form-item" label="企業名稱" prop="name">
                            <Input v-model.trim="editFormValidate.name" maxlength="300" ></Input>
                        </FormItem>
                    </i-Col>
                </Row>
                <Row>
                ...
                <Row>
                    <i-Col span="12">
                        <FormItem class="edit-form-item" label="企業統編" prop="serialNumber">
                            <Input v-model.trim="editFormValidate.serialNumber" maxlength="50"></Input>
                        </FormItem>
                    </i-Col>
                    <i-Col span="12">
                        <FormItem class="edit-form-item" label="服務項目(服務類型、服務對象)" prop="serviceTarget">
                            <Input v-model.trim="editFormValidate.serviceTarget" maxlength="50" ></Input>
                        </FormItem>
                    </i-Col>
                    ...
                    <Row>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="主要連絡人姓名" prop="contactName">
                                <Input v-model.trim="editFormValidate.contactName" maxlength="100"></Input>
                            </FormItem>
                        </i-Col>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="主要連絡人電話" prop="contactPhone">
                                <Input v-model.trim="editFormValidate.contactPhone" maxlength="30" ></Input>
                            </FormItem>
                        </i-Col>
                    </Row>
                    <Row>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="主要連絡人電子郵件" prop="contactEmail">
                                <Input type="email" v-model.trim="editFormValidate.contactEmail" maxlength="254" ></Input>
                            </FormItem>
                        </i-Col>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="主要連絡人職稱" prop="contactJob">
                                <Input v-model.trim="editFormValidate.contactJob" maxlength="100" ></Input>
                            </FormItem>
                        </i-Col>
                    </Row>    
                    <Row>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="次要連絡人姓名" prop="contact2Name">
                                <Input v-model.trim="editFormValidate.contact2Name" maxlength="100"  ></Input>
                            </FormItem>
                        </i-Col>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="次要連絡人電話" prop="contact2Phone">
                                <Input v-model.trim="editFormValidate.contact2Phone" maxlength="30" ></Input>
                            </FormItem>
                        </i-Col>
                    </Row>  
                    <Row>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="次要連絡人電子郵件" prop="contact2Email">
                                <Input type="email" v-model.trim="editFormValidate.contact2Email" maxlength="254" ></Input>
                            </FormItem>
                        </i-Col>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="次要連絡人職稱" prop="contact2Job">
                                <Input v-model.trim="editFormValidate.contact2Job" maxlength="100" ></Input>
                            </FormItem>
                        </i-Col>
                    </Row>  
                    <Row>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="通訊地址" prop="contactAddress">
                                <Input v-model.trim="editFormValidate.contactAddress" maxlength="100" ></Input>
                            </FormItem>
                        </i-Col>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="官方網站" prop="contactWebsite">
                                <Input v-model.trim="editFormValidate.contactWebsite" maxlength="200" ></Input>
                            </FormItem>
                        </i-Col>
                    </Row>
                    <Row>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="其他宣傳管道: FB粉絲頁" prop="contactSite">
                                <Input v-model.trim="editFormValidate.contactSite" maxlength="200"></Input>
                            </FormItem>
                        </i-Col>
                         <i-Col span="12">
    ...
    methods: {
        ...
        getDetail() {
            ...
            if(this.$route.params.id) {
                str = ' uid eq ' + this.$route.params.id
            }else {
            ...
            this._API.getNpos.send(params).then((data) => {
                ...
                _this.id = _this.editFormValidate.id

                // _this.editFormValidate.npoIconURL = baseURL+'uploads/'+_this.editFormValidate.npoIcon
            ...
            this.$refs[name].validate((valid, error) => {
                if (valid) {
                    ...
                    data.push({
                        ...
                        // verified: this.editFormValidate.verified,
                        inventory: this.editFormValidate.inventory, //是否為物資需求組織
