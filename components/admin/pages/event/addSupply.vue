    ...
    <Layout class="main">
        <div class="edit-form">
            ...
            <div class="edit-form-content">
                <div class="form-head">
                    <div class="form-head-title">新增捐贈物資活動</div>
                </div>
                    ...
                    <Row>
                        <i-Col span="12">
                            <FormItem class="edit-form-item" label="活動標籤(新增標籤輸入完後請按Enter鍵選取)" prop="tags">
                                ...
                                <Select class="tagInput" ref="store" v-model="editFormValidate.tags" clearable filterable multiple allow-create @on-create="handleCreate2" placeholder="請選擇">
