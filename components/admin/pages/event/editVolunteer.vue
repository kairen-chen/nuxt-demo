    ...
    <Layout class="main">
        <div class="edit-form">
            ...
            <div class="edit-form-content">
                <div class="form-head">
                    <div class="form-head-title">志工活動資料更新</div>
                </div>
    ...
    methods: {
        ...
        getDetail() {
            ...
            this._API.getEvents.send(params).then((data) => {
                ...
                //tag string to array
                // if(this.editFormValidate.tags != '') {
                //     let tmpArray = this.editFormValidate.tags.split(',');
                ...
                //     });
                // }
                // console.log('__:'+JSON.stringify(this.tagsList))
